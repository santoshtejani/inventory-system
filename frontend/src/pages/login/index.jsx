        ...
        <div>
            <div className='max-w-6xl mx-auto pt-20'>
                <div className='flex flex-wrap justify-center gap-4'>
                    <div class=" relative flex flex-col rounded-md text-black bg-white">
                        <div class="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">Welcome back to <span class="text-[#000]">App</span></div>
                        ...
                        <form class="flex flex-col gap-3">
                            ...
                            <div>
                                <a class="text-sm text-[#000]" href="#">Forgot your password?
                                </a></div>
                            <button type="submit" class="bg-[#000] w-max m-auto px-6 py-2 rounded text-white text-sm font-normal" onClick={()=> navigate("/home")}>Submit</button>

                        </form>
                        <div class="text-sm text-center mt-[1.6rem]">Don’t have an account yet? <a class="text-sm text-[#000]" href="#">Sign up for free!</a></div>
                    </div>
                </div>
            </div>
        </div>
